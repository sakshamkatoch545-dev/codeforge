...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-950 text-white px-4 py-12">
      <div className="max-w-md w-full space-y-6 bg-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-800 transition">
        ...
        <div>
          ...
          <p className="mt-1.5 text-center text-xs text-gray-400 font-medium">
            {isLogin
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-3.5 px-4 border border-transparent text-sm font-black rounded-xl text-white bg-brand-600 hover:bg-brand-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition shadow-lg shadow-brand-500/20 disabled:opacity-50 cursor-pointer"
            >
              {loading ? 'Processing...' : isLogin ? 'Sign In' : 'Create Account (Register)'}
            </button>
          </div>
        </form>
      </div>
